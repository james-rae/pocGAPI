 ...
 */
function convertImageToCanvas(url: string, canvas: HTMLCanvasElement = null, crossOrigin: boolean = true): Promise<any> {
 ...
 */
function convertImagetoDataURL(imageUri: string, imageType: string = 'image/png'): Promise<string> {
