...
function queryGeometryBuilder(esriBundle: EsriBundle): Object {
     ...
     */
    return (options: any): Promise<esri.FeatureSet> => {
...
// where clause
function queryIdsBuilder(esriBundle: EsriBundle): Object {
     ...
     */
    return (options: any): Promise<number[]> => {
        // create and set the esri query parameters
...
function sqlToAql (sqlWhere: string): AqlRoot {
 ...
 */
function sqlAttributeFilter (attributeArray: any, sqlWhere: any, attribAsProperty: boolean = false): Array<Object> {
 ...
 */
function sqlGraphicsVisibility (graphics: any, sqlWhere: string): Array<any> {
